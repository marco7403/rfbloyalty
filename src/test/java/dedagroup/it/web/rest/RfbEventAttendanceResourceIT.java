...
import dedagroup.it.service.RfbEventAttendanceService;
import dedagroup.it.service.dto.RfbEventAttendanceDTO;
import dedagroup.it.service.mapper.RfbEventAttendanceMapper;
...
public class RfbEventAttendanceResourceIT {
    ...
    private static final LocalDate DEFAULT_EVENT_ATTENDANCE = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_EVENT_ATTENDANCE = LocalDate.now(ZoneId.systemDefault());
    ...
    public static RfbEventAttendance createEntity(EntityManager em) {
        RfbEventAttendance rfbEventAttendance = new RfbEventAttendance()
            .eventAttendance(DEFAULT_EVENT_ATTENDANCE);
    ...
    public static RfbEventAttendance createUpdatedEntity(EntityManager em) {
        RfbEventAttendance rfbEventAttendance = new RfbEventAttendance()
            .eventAttendance(UPDATED_EVENT_ATTENDANCE);
        return rfbEventAttendance;
    }
    ...
    public void createRfbEventAttendance() throws Exception {
        ...
        assertThat(testRfbEventAttendance.getEventAttendance()).isEqualTo(DEFAULT_EVENT_ATTENDANCE);
    }
    ...
    public void getAllRfbEventAttendances() throws Exception {
        ...
        restRfbEventAttendanceMockMvc.perform(get("/api/rfb-event-attendances?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].eventAttendance").value(hasItem(DEFAULT_EVENT_ATTENDANCE.toString())));
    }
    ...
    public void getRfbEventAttendance() throws Exception {
        ...
        restRfbEventAttendanceMockMvc.perform(get("/api/rfb-event-attendances/{id}", rfbEventAttendance.getId()))
            ...
            .andExpect(jsonPath("$.eventAttendance").value(DEFAULT_EVENT_ATTENDANCE.toString()));
    }
    ...
    public void updateRfbEventAttendance() throws Exception {
        ...
        RfbEventAttendance testRfbEventAttendance = rfbEventAttendanceList.get(rfbEventAttendanceList.size() - 1);
        assertThat(testRfbEventAttendance.getEventAttendance()).isEqualTo(UPDATED_EVENT_ATTENDANCE);
    }
